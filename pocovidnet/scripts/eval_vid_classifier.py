...
def main():
    ...
    parser.add_argument('--json', type=str, default="../data/video_input_data/cross_val.json")
    parser.add_argument(
        '--genesis_weights', type=str, default='video_genesis_lr1e4'
    )
    parser.add_argument(
        '--frame_model_weights', type=str, default='models/vgg_cam'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--output_dir', type=str, default='evaluation_outputs_30_3.dat'
    )
    ...
    for i in range(5):
        ...
        normal_eval = VideoEvaluator(
            ...
            num_classes=2 #[2-class update - require]
        )
        ...
        for f in files:
            ...
            print(
                # preds.shape,
                preds_framebased.shape)
            print(
                # "genesis pred", vid_pred_genesis,
                "frame based pred", frame_pred
            )
            print("-------------")
    with open(args.output_dir, "wb") as outfile:
        pickle.dump(all_frame_preds, outfile)
